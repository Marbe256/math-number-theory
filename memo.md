...
$$
\begin{aligned}
 \sum (n-k)^3 k^3 &= \sum (n^3 - 3n^2 k + 3nk^2 - k^3)k^3 \\
                 &= n^3 \sum k^3 - 3n^2 \sum k^4 + 3n \sum k^5 - \sum k^6 \\
...
$$
\begin{aligned}
 2^7 - 1^7     &= 1 + 7 \cdot 2 + 21 \cdot 2^2 + 35 \cdot 2^3 + 35 \cdot 2^4 + 21 \cdot 2^5 + 7 \cdot 2^6 \\
 3^7 - 2^7     &= 1 + 7 \cdot 3 + 21 \cdot 3^2 + 35 \cdot 3^3 + 35 \cdot 3^4 + 21 \cdot 3^5 + 7 \cdot 3^6 \\
 &\dots \\
 n^7 - (n-1)^7 &= 1 + 7 \cdot 1 + 21 \cdot 1^2 + 35 \cdot 1^3 + 35 \cdot 1^4 + 21 \cdot 1^5 + 7 \cdot 1^6
\end{aligned}
$$
すべて足すと。
